...
class ListChecklist extends React.Component {
    ...
    getActions(id) {
        return <div><Button href={"/checklists/" + id}>Edit</Button> <Button onClick={this.onDeleteBtClick}>Delete</Button></div>
    }
    ...
    render() {
        return (
            <div>
                <Button bsSize="small" onClick={this.onDeleteBtClick}>Delete</Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Button bsSize="small" href="/checklists/new" >Add</Button>
                <ReactDataGrid
                    rowKey="id"
...
ListChecklist.propTypes = {
  rowKey: React.PropTypes.string.isRequired
};

ListChecklist.defaultProps = {
  rowKey:'id'
};
