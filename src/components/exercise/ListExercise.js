...
class ListExercise extends React.Component {
    ...
    getActions(id) {
        return <div><Button href={"/exercises/" + id}>Edit</Button> <Button onClick={this.onDeleteBtClick}>Delete</Button></div>
    }
    ...
    render() {
        return (
            <div>
                <Button bsSize="small" onClick={this.onDeleteBtClick}>Delete</Button> <Button bsSize="small" href="/exercises/new" >Add</Button>
                <ReactDataGrid
                    rowKey="id"
...
ListExercise.propTypes = {
  rowKey: React.PropTypes.string.isRequired
};

ListExercise.defaultProps = {
  rowKey:'id'
};
